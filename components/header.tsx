...
const navClass =
  "flex min-h-11 min-w-0 items-center justify-center gap-0.5 rounded-xl border border-transparent px-1 py-2 text-[0.6875rem] font-semibold text-muted-foreground hover:border-border hover:bg-card hover:text-primary aria-[current=page]:border-secondary/60 aria-[current=page]:bg-card aria-[current=page]:text-foreground min-[360px]:gap-1 min-[360px]:px-1.5 min-[360px]:text-xs sm:rounded-full sm:px-2.5 sm:text-sm lg:min-h-10 lg:text-[0.8rem] xl:px-3.5"

const navIcons = {
  "/about": CircleUserRound,
  "/procedures": ClipboardList,
  "/patient-guide": ListChecks,
  "/gallery": Images,
  "/locations": MapPin,
  "/contact": Mail,
} as const
    ...
    <header className="sticky top-0 z-50 px-3 pb-2 md:px-6">
      <div className="container px-0">
        ...
        >
          ...
          >
            <span className="whitespace-nowrap font-serif text-base font-semibold text-primary transition-colors group-hover:text-secondary min-[360px]:text-[1.35rem] lg:text-2xl xl:text-[1.65rem]">
              Nicolas Biro, M.D.
            </span>
